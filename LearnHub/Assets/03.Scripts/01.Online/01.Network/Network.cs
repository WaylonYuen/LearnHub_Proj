...
//    #region 構建封包 {可共享}
//    #region 構建 一般型封包 [命名標準： 型態Package() ] (外部封包參數) {可共享} !!!沒有使用
//    /// <summary>
//    /// 構建 一般型封包 string類型
//    /// </summary>
...
//    /// <summary>
//    /// 構建 直發型封包 DataBase String類型(待完善: Login)
//    /// </summary>
//    /// <param name="player"></param>
//    /// <param name="dataBaseType"></param>
//    /// <param name="DataBody"></param>
//    public static void Send_Database_Login(Player player, PackageType packageType, DataBaseType dataBaseType, long AccountID, string[] DataBody) {
...
//        //將所有資料打包成封包
//        byte[] Packet = Build_DataBasePacket(player.Crccode, packageType, AccountID, player.EncryptionMethod, dataBaseType, DataBody_Byte); //組合封包
...
//    /// </summary>
//    /// <param name="Body">封包內容</param>
//    public static long UnpackBody_LongData(byte[] Body) {
